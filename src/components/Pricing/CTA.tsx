        ...
        <section className="relative overflow-hidden">
            ...
            <div className="relative z-10 py-20 text-white">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl lg:text-4xl font-heavy mb-6">آماده شروع هستید؟</h2>
                    <p className="text-xl mb-8 opacity-90">همین امروز پلن مناسب خود را انتخاب کنید</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link href="/contact">
                            <Button
                                size="lg"
                                variant="outline"
                                className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm bg-white/5 text-lg px-8 py-4 cursor-pointer"
                            >
                                مشاوره رایگان
                            </Button>
                        </Link>
