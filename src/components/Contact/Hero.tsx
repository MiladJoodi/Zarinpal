        ...
        <section className="relative overflow-hidden">
            ...
            <div className="relative z-10 text-white py-20 lg:py-28">
                <div className="container mx-auto px-4 text-center">
                    <Badge className="mb-6 bg-accent/20 text-accent border-accent/30 hover:bg-accent/30 text-lg px-6 py-2 select-none">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="border-white/30 text-white hover:bg-white/10 hover:text-white backdrop-blur-sm bg-white/5 text-lg px-8 py-4 cursor-pointer"
                        >
